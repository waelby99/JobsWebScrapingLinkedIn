...
def determine_speciality(title):
    ...
    keywords = {
        ...
        # Dig data et bi
        'BI&BD': ['power bi', 'ssis', 'ssrs', 'ssas', 'business intelligence', 'big data', 'sql', 'administrateur', 'oracle','python', 'machine learning', 'science', 'r', 'scientist','talend','excel'],
        # Embarque
...
def linkedin_scraper(webpage, page_number, writer):
    ...
    if page_number < 500:
        ...
        output_file_path = 'linkedin-jobs-noduplicates.csv'
